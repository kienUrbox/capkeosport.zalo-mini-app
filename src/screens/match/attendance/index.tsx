...
import { Header, Icon, Button, TeamAvatar, ActionBottomSheet } from '@/components/ui';
...
const MatchAttendanceScreen: React.FC = () => {
  ...
  // State for decline reason bottom sheet
  ...
  // Handle decline button - show ActionBottomSheet instead of native prompt
  const handleDecline = () => {
    setShowDeclineSheet(true);
  };

  // Handle decline with reason from ActionBottomSheet
  const handleDeclineWithReason = (reason?: string) => {
  ...
  return (
    <>
      ...
      <ActionBottomSheet
        ...
        type="input"
        title="Báo bận"
        description="Nhập lý do bạn không thể tham gia trận đấu này"
        icon="event_busy"
        iconColor="text-orange-500"
        inputPlaceholder="Lý do báo bận (tùy chọn)..."
        inputMaxLength={200}
        primaryButtonText="Xác nhận báo bận"
        onPrimaryAction={handleDeclineWithReason}
